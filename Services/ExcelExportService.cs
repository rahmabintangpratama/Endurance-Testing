...
namespace Endurance_Testing.Services
{
    ...
    {
        public bool ExportToExcel(List<EnduranceTestResult> testResults, TestSummary testSummary, TestParameters testParameters)
        {
            try
            {
        ...
        private int AddParametersSection(IXLWorksheet worksheet, TestParameters testParameters)
        {
            ...
            worksheet.Cell(paramStartRow, paramStartColumn + 1).Value = testParameters.TotalRequests;
