...
namespace Endurance_Testing
{
    public partial class EnduranceTesting : Form
    {
        ...
        private async void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(textBoxInputRequest.Text, out int totalRequests) || totalRequests <= 0)
            {
                MessageBox.Show("Please enter a valid number of requests.");
                isRunning = false;
                return;
            }
            testRunner.TotalRequests = totalRequests;
        ...
        private void ExportToExcel()
        {
            ...
            {
                Url = testRunner.Url,
                TotalRequests = testRunner.TotalRequests,
                TimeoutInSeconds = testRunner.TimeoutInSeconds,
                DurationInSeconds = testRunner.DurationInSeconds,
                SelectedTimePeriod = selectedTimePeriod
            };

            excelExportService.ExportToExcel(enduranceTestResults, summary, parameters);
        }
        ...
        private void ExportToCsv()
        {
            ...
            csvExportService.ExportToCsv(enduranceTestResults, summary, parameters);
        }
        ...
        private void ExportToJson()
        {
            ...
            jsonExportService.ExportToJson(enduranceTestResults, summary, parameters);
        }
